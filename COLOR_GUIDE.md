...
**IMPORTANT:** purple/fuchsia/magenta has become the generic "AI" color. Do NOT pick this family unless it's correct for the brand's specific story and domain.

> **Exception: intentional ownership.** This warning targets reflexive defaults — choosing purple because it "looks like AI." If a brand has a genuine, documented semantic rationale for purple (archetype, heritage, cultural code, or established ownership in its category), purple is appropriate. The test is Romaniuk's DBA criterion: *Is the color distinctively yours, or just familiar?*
