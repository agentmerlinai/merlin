function createMissionGraphFixture({
    G = 32,
    measureTextWidth,
} = {}) {
...
function buildElkGraph(fixture) {
    return {
        id: "missionGraph",
        layoutOptions: {
...
function buildMissionGraphGeometry(fixture, elkResult) {
...
function validateMissionGraphGeometry(fixture, geometry) {
    const failures = [];
